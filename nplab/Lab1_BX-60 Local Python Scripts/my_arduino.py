...
class LampSlider(Shutter, SerialInstrument):
    ...
    def __init__(self, port=None):
        ...
        ## Add code to wait for Arduino to say READY
        ## self.read()
        
    # def set_speed():
        # self.write('SPEED_PUMP No._ Set Speed')
        ## Every command from python (self.write()) must ens in some line terminator (set in arduino)
        ## In arduino, in loop, decompress this string
        ## Always get it to return something on success/fail(return via serial.println(), read via self.read())
