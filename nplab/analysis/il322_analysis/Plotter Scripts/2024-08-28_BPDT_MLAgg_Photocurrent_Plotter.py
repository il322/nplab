...
Plotter for some photocurrent measurements with DF spectra overlay for different BPDT MLAggs (varying AuNP size)
...
h5_20 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-08-29_BPDT_20nm_MLAgg_Photocurrent.h5")
h5_35 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-09-03_BPDT_35nm_MLAgg_Photocurrent.h5")
h5_57 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-09-04_BPDT_57nm_MLAgg_Photocurrent.h5")
h5_70 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-09-05_BPDT_70nm_MLAgg_Photocurrent.h5")

h5_dict = {20 : h5_20, 35 : h5_35, 57 : h5_57, 70 : h5_70}
...
def get_directory(particle_name):
    ...
    directory_path = r"C:\Users\il322\Desktop\Offline Data\2024-08-28_BPDT_MLAgg_FTO Photocurrent Analysis\\" + particle_name + '\\'
...
''' Run to here and then load spydata '''
...
df_h5 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-08-30_BPDT_MLAgg_DF_SERS_Map.h5")

df_dict = {20 : 'BPDT_Strath20nm_MLAgg_map_1', 
           35 : 'BPDT_Strath35nm_MLAgg_map_0', 
           57 : 'BPDT_Strath57nm_MLAgg_map_0', 
           70 : 'BPDT_Strath70nm_MLAgg_map_0', 
           80 : 'BPDT_Strath80nm_MLAgg_map_0'}
...
my_h5 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-08-30_BPDT_MLAgg_DF_SERS_Map.h5")

SERS_dict = {20 : 'BPDT_Strath20nm_MLAgg_SERS_map_0', 
           35 : 'BPDT_Strath35nm_MLAgg_SERS_map_0', 
           57 : 'BPDT_Strath57nm_MLAgg_SERS_map_0', 
           70 : 'BPDT_Strath70nm_MLAgg_SERS_map_0', 
           80 : 'BPDT_Strath80nm_MLAgg_SERS_map_0'}
...
this_particle.name = 'BPDT 20 nm MLAgg'
...
this_particle = Particle()
this_particle.name = 'BPDT 35 nm MLAgg'
this_particle.size = 35
my_h5 = h5_dict[this_particle.size]
this_particle.df_avg = df_avg_dict[this_particle.size]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['BPDT_35nm_MLAgg_0']['Potentiostat']
skip_spectra = ["currents_PEC_OCP_Good_550nm_50nmFWHM_toggle_50s_OCP_0"]
...
for key in group.keys():
    ...
    if 'OCP' in key and key not in skip_spectra and 'test' not in key and 'currents' in key and 'Good' in key:
            spectrum = group[key]
            spectra.append(spectrum)
this_particle.ocp_spectra = spectra
...
for key in group.keys():
    ...
    if 'OCP' in key and key not in skip_spectra and 'test' not in key and 'potential' in key and 'Good' in key:
            spectrum = group[key]
            spectra.append(spectrum)
this_particle.ocp_spectra_voltage = spectra
...
this_particle = Particle()
this_particle.name = 'BPDT 70 nm MLAgg'
this_particle.size = 70
my_h5 = h5_dict[this_particle.size]
this_particle.df_avg = df_avg_dict[this_particle.size]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['BPDT_70nm_MLAgg_0']
skip_spectra = ["PEC_CA_750nm_50nmFWHM_toggle_50s_CA_-0.4V_0",
                "potentials_PEC_OCP_450nm_50nmFWHM_toggle_50s_OCP_0",
                ]
...
fig.suptitle('BPDT MLAgg on FTO Darkfield', fontsize = 'x-large')
...
if save == True:
    ...
    fig.savefig(save_dir + 'BPDT MLAgg DF' + '.svg', format = 'svg', bbox_inches='tight')
    plt.close(fig)
...
fig.suptitle('BPDT MLAgg on FTO 633 nm SERS', fontsize = 'x-large')
...
if save == True:
    ...
    fig.savefig(save_dir + 'BPDT MLAgg SERS' + '.svg', format = 'svg', bbox_inches='tight')
    plt.close(fig)
