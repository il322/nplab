...
(samples:
     2024-07-22_Co-TAPP-SMe_60nm_MLAgg_on_ITO_a)
...
save_h5 = datafile.DataFile(r"C:\Users\il322\Desktop\Offline Data\2024-07-29_Processed_Data.h5")
...
def get_directory(particle_name):
    ...
    directory_path = r'C:\Users\il322\Desktop\Offline Data\2024-07-29 Co-TAPP-SMe MLAgg EChem SERS Analysis\_' + particle_name + '\\'
...
powerseries = []
for i, spectrum in enumerate(timescan.Y):
    spectrum = SERS.SERS_Spectrum(x = timescan.x, y = spectrum, intensity_calibrated = True, laser_power = timescan.laser_power, integration_time = timescan.cycle_time)
