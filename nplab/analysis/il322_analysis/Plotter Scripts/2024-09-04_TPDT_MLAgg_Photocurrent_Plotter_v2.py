...
h5_57 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-09-19_TPDT_57nm_70nm_MLAgg_Photocurrent.h5")
h5_70 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-09-19_TPDT_57nm_70nm_MLAgg_Photocurrent.h5")
...
def process_ocp_voltage_new(particle):
...
df_dict = {20 : 'TPDT_Strath20nm_MLAgg_SERS_map_0', 
           35 : 'TPDT_Strath35nm_MLAgg_SERS_map_0', 
           57 : 'TPDT_Strath57nm_MLAgg_SERS_map_1', 
           70 : 'TPDT_Strath70nm_MLAgg_SERS_map_0', 
           80 : 'TPDT_Strath80nm_MLAgg_SERS_map_0'}
...
for size in sizes:
    ...
    if size == 20:
        scan = df_h5['ref_meas_0'][df_dict[size]]
    elif size == 35:
        scan = df_h5['ref_meas_0']['TPDT_Strath20nm_MLAgg_SERS_map_0']['grid_9_17'][df_dict[size]]
    else:
...
SERS_dict = {20 : None, 
           35 : 'TPDT_Strath35nm_MLAgg_SERS_map_0', 
           57 : 'TPDT_Strath57nm_MLAgg_SERS_map_2', 
           70 : 'TPDT_Strath70nm_MLAgg_SERS_map_1', 
           80 : 'TPDT_Strath80nm_MLAgg_SERS_map_1'}
...
spectra = []
for key in group.keys():
    if 'PEC_CA' in key and key not in skip_spectra and '-0.4V' not in key:   
            spectrum = group[key]
            spectra.append(spectrum)           
group2 = my_h5['TPDT_20nm_MLAgg_1']
...
this_particle = Particle()
this_particle.name = 'TPDT 70 nm MLAgg'
this_particle.size = 70
my_h5 = h5_dict[this_particle.size]
this_particle.df_avg = df_avg_dict[this_particle.size]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['TPDT_70nm_MLAgg_1']['Potentiostat']
skip_spectra = ["PEC_CA_450nm_50nmFWHM_toggle_50s_CA_-0.2V_0",
                "PEC_CA_450nm_50nmFWHM_toggle_50s_CA_0V_0",
                "PEC_CA_450nm_50nmFWHM_toggle_50s_CA_0.2V_0",
                "PEC_CA_450nm_50nmFWHM_toggle_50s_CA_0.4V_0"]
...
for particle in particles:
    ...
    if particle.size == 20:
        ...
        process_ocp_voltage_new(particle)
    process_cv(particle)
