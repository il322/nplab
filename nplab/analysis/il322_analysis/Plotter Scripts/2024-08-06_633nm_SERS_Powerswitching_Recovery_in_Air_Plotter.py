...
Copied from 2024-07-30_633nm_CA_Switching_Plotter_v2.py
...
save_h5 = datafile.DataFile(r"C:\Users\il322\Desktop\Offline Data\2024-08-06_Processed_Powerswitching_in_Air_Data.h5")
...
def get_directory(particle_name):
    ...
    directory_path = r'C:\Users\il322\Desktop\Offline Data\2024-08-06 633nm SERS Powerswitch Recovery in Air Analysis\_' + particle_name + '\\'
...
for particle_scan in scan_list:
    ...
    for particle in particle_list[0:49]:
