...
Copied from 2024-10-25_Co-TAPP-SMe_MLAgg_Photocurrent_Plotter.py

Data:

(samples: 2024-11-05_M-TAPP-SMe_Strath20nm_MLAggs_on_ITO)
...
if save_to_h5 == True:
    save_h5 = datafile.DataFile(r"C:\Users\il322\Desktop\Offline Data\2024-11-08_Processed_M-TAPP-SMe_S20nm_MLAgg_PEC_Data.h5")

## PEC h5 Files

my_h5 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-11-08_M-TAPP-SMe_S20nm_MLAgg_PEC.h5")
...
def get_directory(particle_name):
    ...
    directory_path = r"C:\Users\il322\Desktop\Offline Data\2024-11-08_M-TAPP-SMe_S20nm_MLAgg_ITO Photocurrent Analysis\\" + particle_name + '\\'
...
df_h5 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-11-06_M-TAPP-SMe_20nm_MLAgg_on_ITO_DF_SERS_Map.h5")

df_dict = {'H2' : '2024-11-05_H2-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0', 
           'Ni' : '2024-11-05_Ni-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0', 
           'Zn' : '2024-11-05_Zn-TAPP-SMe_Strath20nm_MLAgg_on_ITO_0'}
...
for molecule in molecules:
    ...
    df_spectra = df_spectra_dict[molecule]
    df_avg = df_avg_dict[molecule]
    if molecule == 'Ni':
        scan = df_h5['PT_lab']['2024-11-05_H2-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0']['grid_16_18'][df_dict[molecule]]        
    else:
        scan = df_h5['PT_lab'][df_dict[molecule]]
    ...
    df_avg_dict[molecule] = df_avg
    

#%% SERS

my_h5 = h5py.File(r"C:\Users\il322\Desktop\Offline Data\2024-11-06_M-TAPP-SMe_20nm_MLAgg_on_ITO_DF_SERS_Map.h5")


SERS_dict = {'H2' : '2024-11-05_H2-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0', 
           'Ni' : '2024-11-05_Ni-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0', 
           'Zn' : '2024-11-05_Zn-TAPP-SMe_Strath20nm_MLAgg_on_ITO_0'}
...
neon_ref = my_h5['PT_lab']['neon_lamp_0']
neon_ref = SERS.SERS_Spectrum(neon_ref)
neon_ref.normalise()
neon_ref_peaks = neon_ref.x[spt.detect_maxima(neon_ref.y_norm, lower_threshold = 0.008)]
neon_ref_peaks = neon_ref_peaks[0:-5]
neon_ref_peaks_y = neon_ref.y_norm[spt.detect_maxima(neon_ref.y_norm, lower_threshold = 0.008)]
neon_ref_peaks_y = neon_ref_peaks_y[0:-5]
neon_ref.__dict__.pop('dset')
neon_ref_peaks = np.delete(neon_ref_peaks, 7)
neon_ref_peaks_y = np.delete(neon_ref_peaks_y, 7)
...
for molecule in molecules:
    ...
    SERS_spectra = SERS_spectra_dict[molecule]
    SERS_avg = SERS_avg_dict[molecule]
    if molecule == 'Ni':
        scan = df_h5['PT_lab']['2024-11-05_H2-TAPP-SMe_Strath20nm_MLAgg_on_ITO_a_0']['grid_16_18'][SERS_dict[molecule]]        
    else:
        scan = df_h5['PT_lab'][SERS_dict[molecule]]
    ...
    SERS_avg_dict[molecule] = SERS_avg
...
this_particle.name = 'H2-TAPP-SMe 20 nm MLAgg'
this_particle.molecule = 'H2'
this_particle.size = 20
this_particle.df_avg = df_avg_dict[this_particle.molecule]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['H-TAPP-SMe_Strath20nm_MLAgg_on_ITO_0']
skip_spectra = []
...
this_particle.ca_offset[51:71] = 2
...
this_particle = Particle()
this_particle.name = 'Ni-TAPP-SMe 20 nm MLAgg'
this_particle.molecule = 'Ni'
this_particle.size = 20
this_particle.df_avg = df_avg_dict[this_particle.molecule]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['Ni-TAPP-SMe_Strath20nm_MLAgg_on_ITO_0']
skip_spectra = []
...
this_particle = Particle()
this_particle.name = 'Zn-TAPP-SMe 20 nm MLAgg'
this_particle.molecule = 'Zn'
this_particle.size = 20
this_particle.df_avg = df_avg_dict[this_particle.molecule]
this_particle.power_calibration_group = my_h5['power_calibration_0']
group = my_h5['Zn-TAPP-SMe_Strath20nm_MLAgg_on_ITO_0']
skip_spectra = []
...
color_dict = {'Co' : 'blue', 'Ni' : 'red', 'Zn' : 'green', 'H2' : 'purple', 'BPDT' : 'brown', 'TPDT' : 'pink'}

fig, ax = plt.subplots(1, 1, figsize=[16,10])
ax.set_xlabel('Wavelength (nm)', fontsize = 'x-large')
ax.set_ylabel('Darkfield Scattering', fontsize = 'x-large')
fig.suptitle('M-TAPP-SMe 20nm MLAgg on ITO Darkfield', fontsize = 'x-large')
...
for i, molecule in enumerate(molecules):
    ...
    spectrum = df_avg_dict[molecule]    
    ax.plot(spectrum.x, spectrum.y - spectrum.y.min(), color = color_dict[molecule], alpha = 1, label = str(molecule) + '-TAPP-SMe')
...
if save == True:
    ...
    fig.savefig(save_dir + 'M-TAPP-SMe 20nm MLAgg DF' + '.svg', format = 'svg', bbox_inches='tight')
    plt.close(fig)
...
fig.suptitle('M-TAPP-SMe 20nm MLAgg on ITO 633 nm SERS', fontsize = 'x-large')

for i, molecule in enumerate(molecules):
        
    SERS_spectra = SERS_spectra_dict[molecule]
    
    spectrum = SERS_avg_dict[molecule]    
    ax.plot(spectrum.x, spectrum.y, color = color_dict[molecule], alpha = 1, label = str(molecule) + '-TAPP-SMe')
...
if save == True:
    ...
    fig.savefig(save_dir + 'M-TAPP-SMe 20nm MLAgg SERS' + '.svg', format = 'svg', bbox_inches='tight')
    plt.close(fig)
